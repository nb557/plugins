...
(function () {
  ...
  function component(object) {
    ...
    this.proxy = function (name) {
      ...
      var proxy2 = Lampa.Storage.field('online_mod_proxy_other_url');
      var alt_proxy = Lampa.Storage.field('online_mod_proxy_other') === true && proxy2 ? proxy2 : proxy1;
