...
(function () {
    ...
    function hdvb(component, _object) {
      var network = new Lampa.Reguest();
      var extract = [];
      var backend = 'http://back.freebie.tom.ru/lampa/hdvburl?v=2114';
      var object = _object;
      var select_title = '';
      var select_id = '';
      var balanser_id = '';
