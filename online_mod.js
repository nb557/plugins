...
(function () {
      ...
      network["native"](embed + url, function (str) {
        ...
        if (MOVIE_ID && IDENTIFIER && PLAYER_CUID) {
          ...
          network["native"](embed + data_url, function (user_data_script) {
            ...
            try {
              user_data = user_data_script && eval(user_data_script.replace(/\$\[[^\]]*\]/, 'return (function(x,y,z){return y;})'));
            } catch (e) {}

            if (user_data && user_data.st && user_data.e) {
              ...
              file_url = Lampa.Utils.addUrlComponent(file_url, "st=" + user_data.st);
              file_url = Lampa.Utils.addUrlComponent(file_url, "e=" + user_data.e);
  ...
  function hdvb(component, _object) {
    ...
    var extract = {};
    var results = [];
    var backend = 'http://back.freebie.tom.ru/lampa/hdvburl?v=1715';
    var object = _object;
    var select_title = '';
    var select_id = '';
    var filter_items = {};
    ...
    this.find = function () {
      ...
      var vcdn_search = function vcdn_search() {
        ...
        if (balanser == 'videoapi') {
          url = _this2.proxy('videoapi') + 'https://videoapi.tv/api/';
          params = Lampa.Utils.addUrlComponent('', 'api_token=qR0taraBKvEZULgjoIRj69AJ7O6Pgl9O');
        } else {
          url = _this2.proxy('videocdn') + 'https://videocdn.tv/api/';
          params = Lampa.Utils.addUrlComponent('', 'api_token=3i40G5TSECmLF77oAqnEgbx61ZWaOYaE');
        }
      ...
      var letgo = function letgo() {
        if (['rezka2', 'kinobase', 'filmix', 'cdnmovies'].indexOf(balanser) >= 0) {
          ...
          if (['videocdn', 'videoapi'].indexOf(balanser) >= 0 || Lampa.Storage.field('online_mod_skip_kp_search') === true) vcdn_search();else kp_search();
        }
      };
  ...
  Lampa.Storage.set('online_mod_proxy_other', 'false');
