//28.05.2023 - Alt proxy for rezka
...
(function () {
  ...
  function component(object) {
    ...
    this.proxy = function (name) {
      ...
      var proxy2 = 'https://6a0e.misisi-2021.workers.dev/';
