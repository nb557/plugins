...
(function () {
  ...
  function component(object) {
    ...
    var filter_sources = ['videocdn', 'rezka', 'rezka2', 'kinobase', 'collaps', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
