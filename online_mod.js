//18.10.2022 - Use network.native() for rezka2 and fix collaps
...
(function () {
  ...
  function rezka2(component, _object) {
    ...
    var embed = prox ? prox + 'http://metaivi.com/' : rezka2Mirror();
    var object = _object;
    var select_title = '';
    var prefer_mp4 = Lampa.Storage.field('online_mod_prefer_mp4') === true;
    ...
    function rezka2Mirror() {
      ...
      if (!url) return 'https://metaivi.com/';
  ...
  function collaps(component, _object) {
    var network = new Lampa.Reguest();
    var extract = {};
    var embed = component.proxy('collaps') + 'http://api.loadbox.ws/embed/';
    var object = _object;
    var select_title = '';
  ...
  function component(object) {
    ...
    var filter_sources = ['videocdn', 'rezka', 'rezka2', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
    ...
    this.find = function () {
      ...
      var letgo = function letgo() {
        if (balanser == 'kinobase' || balanser == 'filmix' || balanser == 'cdnmovies' || balanser == 'rezka2') {
          _this2.extendChoice();
  ...
  Lampa.Listener.follow('app', function (e) {
    if (e.type == 'ready') addFilmixToMenu();
  });
  ...
  addOnlineModToMenu();
  Lampa.Listener.follow('app', function (e) {
    if (e.type == 'ready') addOnlineModToMenu();
  });
  Lampa.Settings.listener.follow('open', function (e) {
